...
const Evolution = props =>
  ...
  >
    <Row style={{ height: `${90}%` }}>
          ...
          <Col xs="6" sm="6" lg="6" style={{ paddingLeft: `${0}px`, paddingRight: `${0}px`, paddingRight: `${15}px` }}>
          <Card style={{ height: `${100}%`, width: `${100}%`, paddingRight: `${0}px`  }}>

            <Row style={{ height: `${30}%`, marginLeft: `${15}px`, marginTop: `${25}px`, width: `${100}%`}}>
            ...
            <Row style={{ height: `${60}%`, width: `${100}%`, marginRight: `${0}px`, marginLeft: `${15}px`, }}>
              ...
              <Row style={{ height: `${20}%`, marginTop: `${35}px`, width: `${100}%`}}>
    ...
    <Row style={{ height: `${10}%`, marginTop: `${15}px` }}>
      <Card style={{ height: `${100}%`, width: `${100}%`, paddingRight: `${0}px`  }}>             </Card>
    </Row>
  </div>;
